...
export KBUILD_BUILD_USER="JohnFrancisMcFall"
...
echo -e "This is an Automated Build of Darkness Kernel. Flash at your own risk!" > releasenotes.md
...
cp UPDATE-AnyKernel2.zip Darkness-$GITHUB_RUN_ID-$GITHUB_RUN_NUMBER.zip
BUILD_END=$(date +"%s")
DIFF=$((BUILD_END - BUILD_START))
tg_post_build "Darkness-$GITHUB_RUN_ID-$GITHUB_RUN_NUMBER.zip" "Build took : $((DIFF / 60)) minute(s) and $((DIFF % 60)) second(s)"
